...
import YellsSection from './scripts/yells';
import WorksSection from './scripts/works';
...
Vue.component('yells-section', YellsSection);
Vue.component('works-section', WorksSection);
